...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        buttonItem(ModBlocks.MOONSTONE_BUTTON, ModBlocks.MOONSTONE_BLOCK);

        evenSimplerBlockItem(ModBlocks.MOONSTONE_STAIRS);
        evenSimplerBlockItem(ModBlocks.MOONSTONE_SLAB);
        evenSimplerBlockItem(ModBlocks.MOONSTONE_FENCE_GATE);
        evenSimplerBlockItem(ModBlocks.MOONSTONE_PRESSURE_PLATE);

        trapdoorItem(ModBlocks.MOONSTONE_TRAP_DOOR);
